...
class List extends Component {
    render() {
        ...
        let elmItem     = <tr><th  style={{width: '20%'}} className="text-center" colSpan={4}>No work to do</th></tr>;
        if(items.length > 0 ){
        ...
        return (
            <div className="panel panel-success">
                ...
                <table className="table table-hover ">
                    <thead>
                        <tr>
                            <th style={{width: '20%'}} className="text-center">Content</th>
                            <th style={{width: '20%'}} className="text-center">Task</th>
