                ...
                <div className="socialContact">
                    <div className="container">
                        ...
                        <div className="col-3">
                            ...
                            <div className="col-6">
                                    <ul className="list-footer">
                                        <li><p>HOTLINE : <span className="list-footer-info">88889999000</span></p></li>
                                        <li><p>EMAIL SUPPORT: <span className="list-footer-info">brokenfang@gmail.vn</span></p></li>
                                        <li><p>ADDRESS : <span className="list-footer-info">ON THE EARTH</span></p></li>
                                        <li><p>WORKING HOURS : <span className="list-footer-info">ALL DAY </span></p></li>
                                    </ul>
                            </div>
                        </div>
